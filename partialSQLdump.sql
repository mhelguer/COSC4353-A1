...
CREATE TABLE `fuel_orders` (
  ...
  `gallons_requested` decimal(10,0) NOT NULL,
  `delivery_address` varchar(45) DEFAULT NULL,
  `delivery_date` date DEFAULT NULL,
  `price_per_gallon` decimal(10,0) DEFAULT NULL COMMENT 'to be calculated by pricing module',
  `total_due` decimal(10,0) DEFAULT NULL COMMENT 'calculated, gallons*price',
...
-- Dump completed on 2021-07-02 19:46:19
